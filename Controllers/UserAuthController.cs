...
namespace WebAPIAuth.Controllers
{
    ...
    public class UserAuthController : ControllerBase
    {
        ...
        private string GeneratedJwtToken(ApplicationUser user)
        {
            ...
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_jwtKey)); // Tạo khóa bí mật (Signing Key)
            var creds = new SigningCredentials(key, SecurityAlgorithms.HmacSha256); // SigningCredentials xác định thuật toán ký số (HMAC-SHA256) và khóa bí mật để mã hóa JWT.
